 ...
 * Loaded by config.php — do not include directly.
 */
...
function seedContentData(PDO $db): void {
    ...
    // Contact page
    $s->execute(['contact', 'intro', '<p>Sie haben Interesse am Bogenschießen? Dann schauen Sie doch mal bei unserem <a href="anfaengerkurs.php">Anfängerkurs</a> vorbei.</p><p>Sie haben Fragen zu unserem Verein?</p><p>Sie würden gerne Bogenschießen bei einer Veranstaltung anbieten?</p><p>Dann melden Sie sich bei uns.</p>']);
